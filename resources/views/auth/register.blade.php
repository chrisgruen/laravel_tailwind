	...
	--}}
		<div class="card-w-full">
			<div class="relative flex flex-col content-center min-w-0 rounded break-words border bg-white border-1 border-gray-300">
				<div class="py-3 px-6 mb-0 bg-gray-100 border-b-1 border-gray-300 text-gray-900">@lang('messages.privateOrBusiness')</div>
				<div class="flex-auto p-6">
					<p id="questionText">@lang('messages.regQuestionCompany')</p>
